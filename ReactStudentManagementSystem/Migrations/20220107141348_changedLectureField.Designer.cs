...
namespace ReactStudentManagementSystem.Migrations
{
    ...
    [Migration("20220107141348_changedLectureField")]
    partial class changedLectureField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReactStudentManagementSystem.Models.Lecture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReactStudentManagementSystem.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReactStudentManagementSystem.Models.Student_has_lectures", b =>
                {
            ...
            modelBuilder.Entity("ReactStudentManagementSystem.Models.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReactStudentManagementSystem.Models.Lecture", b =>
                {
                    b.HasOne("ReactStudentManagementSystem.Models.Teacher", "lecturer")
                        .WithMany("lectures")
            ...
            modelBuilder.Entity("ReactStudentManagementSystem.Models.Student_has_lectures", b =>
                {
                    b.HasOne("ReactStudentManagementSystem.Models.Lecture", "lecture")
                        .WithMany("lecture_Has_Students")
                        .HasForeignKey("lecture_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ReactStudentManagementSystem.Models.Student", "student")
